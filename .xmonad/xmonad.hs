...
myWorkspaces =
  [
     "0:Term",
     "1:Web",   "2:Dev-J",  "3:Media",
     "4:File"
  ]

startupWorkspace = "0:Term"  -- which workspace do you want to be on after launch?
...
myKeyBindings =
  [
    ...
    , ((myModMask, xK_s), spawn "gnome-screenshot")
    , ((0, 0x1008ff02), spawn "/home/sahil/.xmonad/brightness.sh inc")
    , ((0, 0x1008ff03), spawn "/home/sahil/.xmonad/brightness.sh dec")
...
myManagementHooks = [
  ...
  , (className =? "vlc") --> doF (W.shift "3:Media")
  , (className =? "Thunar") --> doF (W.shift "4:File")
  , (className =? "jetbrains-idea-ce") --> doF (W.shift "2:Dev-J")
  ]
